...
// GetOne ...
// @Title GetOne
// @Description get Mutant by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Mutant
// @Failure 403 :id is empty
// @router /:id [get]
func (c *MutantController) GetOne() {
...
// Put ...
// @Title Put
// @Description update the Mutant
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Mutant	true		"body for Mutant content"
// @Success 200 {object} models.Mutant
// @Failure 403 :id is not int
// @router /:id [put]
func (c *MutantController) Put() {

}

// Delete ...
// @Title Delete
// @Description delete the Mutant
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *MutantController) Delete() {
